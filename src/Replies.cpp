...
std::string Replies::getReply(ReplyCode code, const std::string& userNick,
  ...
  switch (code) {
    ...
    case RPL_WELCOME:
      ...
      //: server 004 <nick> <servername> <version> <available umodes> <available
      //: cmodes> [<cmodes with param>]
      // ??? -> return prefix + "004 " + userNick + " " + serverName + " " +
      // arg1 + " " + arg2 + " " + arg3 + "\r\n";

    case RPL_TOPIC:
      // shows the topic upon command or upon joining. arg1 is channel, arg2 the
      // topic
    ...
    case ERR_NOSUCHCHANNEL:
      ...
      //     // arg1: channel name
      //     return prefix + "404 " + userNick + " " + arg1 + " :Cannot send to
      //     channel\r\n";
    ...
    case ERR_NICKNAMEINUSE:
      ...
      //     return prefix + "441 " + userNick + " " + arg1 + " :They aren't on
      //     that channel\r\n";
    ...
    case ERR_CHANNELISFULL:
      ...
      //     // arg1: mode char
      //     return prefix + "472 " + userNick + " " + arg1 + " :is unknown mode
      //     char to me\r\n";
