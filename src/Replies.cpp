...
std::string Replies::getReply(ReplyCode code, const std::string &userNick, const std::string &arg1, const std::string &arg2)
{
	...
	// ==========================================
	case RPL_WELCOME:
		return prefix + "001 " + userNick + " :Welcome to the Internet Relay Network " + userNick + "!" + arg1 + "@" + arg2 + "\r\n";

		// case RPL_YOURHOST:
		//     // arg1: server version
		//     return prefix + "002 " + userNick + " :Your host is " + serverName
		//     + ", running version " + arg1 + "\r\n";

		// case RPL_CREATED:
		//     // arg1: creation date
		//     return prefix + "003 " + userNick + " :This server was created "
		//     + arg1 + "\r\n";

		// case RPL_MYINFO:
		// arg1: version, arg2: user modes, arg3: channel modes
		//: server 004 <nick> <servername> <version> <available umodes>
		//: <available cmodes> [<cmodes with param>]
		// ??? -> return prefix + "004 " + userNick + " " + serverName + " " +
		// arg1 + " " + arg2 + " " + arg3 + "\r\n";

	case RPL_TOPIC:
		// shows the topic upon command or upon joining. arg1 is channel, arg2
		// the topic
		return prefix + "332 " + userNick + " " + arg1 + " " + arg2 + "\r\n";
	case RPL_NOTOPIC:
		// shows info that there is no topic in case of input TOPIC with just
		// channel as msg.params[0] arg1 is channel again, there is no arg2 but
		// hardcoded message \/
	...
	case ERR_NOSUCHCHANNEL:
		...
		//     // arg1: channel name
		//     return prefix + "404 " + userNick + " " + arg1 + " :Cannot send
		//     to channel\r\n";

		// case ERR_TOOMANYCHANNELS:
		//     return prefix + "405 " + userNick + " " + arg1 + " ::You have
	...
	case ERR_NICKNAMEINUSE:
		...
		//     return prefix + "441 " + userNick + " " + arg1 + " :They aren't
		//     on that channel\r\n";
	...
	case ERR_CHANNELISFULL:
		...
		//     // arg1: mode char
		//     return prefix + "472 " + userNick + " " + arg1 + " :is unknown
		//     mode char to me\r\n";
	...
	case ERR_INVITEONLYCHAN:
		...
		//     // arg1: channel name
		//     return prefix + "474 " + userNick + " " + arg1 + " :Cannot join
		//     channel (+b)\r\n";
	...
	case ERR_BADCHANNELKEY:
		...
		//     return prefix + "481 " + userNick + " :Permission Denied- You're
		//     not an IRC operator\r\n";
